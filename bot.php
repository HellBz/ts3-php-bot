...
$debug = true;			//When enabled will print some debug info
/////////////////////////////////////////////////
...
if($debug) echo("Connected and name set\n");
...
function onTextmessage(TeamSpeak3_Adapter_ServerQuery_Event $event, TeamSpeak3_Node_Host $host)
{
  ...
  $group = fetchGroup($invoker);
      
  if($group == "6" OR $group == "7" OR $group == "9") { // here I check if the user has access to bot's commands
